# Generated by Powerlevel10k configuration wizard on 2026-04-08 at 16:50 +07.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    os_icon                 # server icon
    context                 # user@hostname (always visible)
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    status                  # exit code (hidden on success)
  ...
  # Custom icon: server rack (Nerd Font ).
  ...
  ######################################[ ram: free RAM ]#######################################
  # RAM color.
  typeset -g POWERLEVEL9K_RAM_FOREGROUND=79
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_BACKGROUND=58
  # Default context color (no privileges, no SSH).
  typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND=220
  typeset -g POWERLEVEL9K_CONTEXT_BACKGROUND=58
  ...
  typeset -g POWERLEVEL9K_IP_INTERFACE='[ew].*|eth.*|ens.*|enp.*'
  # Custom icon.
